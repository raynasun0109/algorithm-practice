...
//     }
//
//     while (dbQueue.size()>1 && isPalindrome){
//         let firstChar=dbQueue.removeFront();
//         let lastChar=dbQueue.removeBack();
//
...
//         let firstChar=lowerString.shift();
//         let lastChar=lowerString.pop();
//
//         isPalindrome= firstChar==lastChar;
//     }
//     return isPalindrome;
...
function palindromeChecker(testString) {
    ...
    const lowerString = reverseString = testString.toLocaleLowerCase().split('')
    return lowerString.join('')===reverseString.reverse().join('');
}
